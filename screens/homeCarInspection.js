    ...
    return (
        ...
        <View style={styles.container}>
            ...
            <ScrollView>
                ...
                <Text style={styles.addTextChoose}>Why AutoFinder is more credible for Car Inspection?</Text>
                <FeatureLine imageSource={require('../assets/reports.png')} text="Extensive reports of vehicles" />
                <FeatureLine imageSource={require('../assets/staff.png')} text="Skilled and certified staff" />
                <FeatureLine imageSource={require('../assets/inspection.png')} text="Satisfied inspection" />

                <Text style={styles.sellWorkText}>How AutoFinder Car Inpection Works?</Text>
                <WorksellForItForMe imageSource={require('../assets/number-1.png')} text="Sign Up for car inpection services" />
                <WorksellForItForMe imageSource={require('../assets/number-2.png')} text="Book a time and location for the car inspection" />
                <WorksellForItForMe imageSource={require('../assets/number-3.png')} text="Team of Experts will visit the vehicle owner and conduct the inpections" />
                <WorksellForItForMe imageSource={require('../assets/number-3.png')} text="Get your detailed inspection report in an hour via WhatsApp or email" />
                ...
                <Text style={styles.summaryText}>AutoFinder car inspection serves as a valuable resource for both buyers and sellers in the used car market. It promotes transparency, trust and informed decision making, helping consumers make safer and more confident choices when purchasing a vehicle.</Text>
