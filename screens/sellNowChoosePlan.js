        ...
        <View style={styles.container}>
            ...
            <View style={styles.roundedViewsContainer}>
                <View style={styles.roundedView}>
                    ...
                    <Text style={styles.subtext}>Need to sell your car without negotiating for the best offers</Text>
                    <TouchableOpacity><Text style={styles.textButton} onPress={handleSellItForMe}>I want experts to sell my car</Text></TouchableOpacity>
                </View>
                <View style={styles.roundedView}>
                    ...
                    <TouchableOpacity><Text style={styles.textButton} onPress={handleSellItMyself}>I can find the best offer</Text></TouchableOpacity>
                </View>
            </View>
        </View>
    );
